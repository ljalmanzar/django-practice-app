"""
Django settings for yt_tutorial project.
...
SECRET_KEY = 'ktce$#08cu=0mq&mg(wab5(5e%m4iypbl5g^)!pbysx=6d*q7d'
...
WSGI_APPLICATION = 'yt_tutorial.wsgi.application'
...
# So files dont get overwritten if use uploads same name as existing
AWS_S3_FILE_OVERWRITE = False
# Recommended None by django-storage
